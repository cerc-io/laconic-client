    ...
    export class ChainConfig extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("gray_glacier_block" in data && data.gray_glacier_block != undefined) {
                    this.gray_glacier_block = data.gray_glacier_block;
                }
                if ("merge_netsplit_block" in data && data.merge_netsplit_block != undefined) {
                    this.merge_netsplit_block = data.merge_netsplit_block;
                }
                if ("shanghai_block" in data && data.shanghai_block != undefined) {
                    this.shanghai_block = data.shanghai_block;
                }
                if ("cancun_block" in data && data.cancun_block != undefined) {
                    this.cancun_block = data.cancun_block;
                }
            }
        }
        get homestead_block() {
        ...
        static fromObject(data: {
            ...
            if (data.gray_glacier_block != null) {
                message.gray_glacier_block = data.gray_glacier_block;
            }
            if (data.merge_netsplit_block != null) {
                message.merge_netsplit_block = data.merge_netsplit_block;
            }
            if (data.shanghai_block != null) {
                message.shanghai_block = data.shanghai_block;
            }
            if (data.cancun_block != null) {
                message.cancun_block = data.cancun_block;
            }
            return message;
        }
        toObject() {
            ...
            if (this.gray_glacier_block != null) {
                data.gray_glacier_block = this.gray_glacier_block;
            }
            if (this.merge_netsplit_block != null) {
                data.merge_netsplit_block = this.merge_netsplit_block;
            }
            if (this.shanghai_block != null) {
                data.shanghai_block = this.shanghai_block;
            }
            if (this.cancun_block != null) {
                data.cancun_block = this.cancun_block;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.homestead_block.length)
                writer.writeString(1, this.homestead_block);
            if (this.dao_fork_block.length)
                writer.writeString(2, this.dao_fork_block);
            if (this.dao_fork_support != false)
                writer.writeBool(3, this.dao_fork_support);
            if (this.eip150_block.length)
                writer.writeString(4, this.eip150_block);
            if (this.eip150_hash.length)
                writer.writeString(5, this.eip150_hash);
            if (this.eip155_block.length)
                writer.writeString(6, this.eip155_block);
            if (this.eip158_block.length)
                writer.writeString(7, this.eip158_block);
            if (this.byzantium_block.length)
                writer.writeString(8, this.byzantium_block);
            if (this.constantinople_block.length)
                writer.writeString(9, this.constantinople_block);
            if (this.petersburg_block.length)
                writer.writeString(10, this.petersburg_block);
            if (this.istanbul_block.length)
                writer.writeString(11, this.istanbul_block);
            if (this.muir_glacier_block.length)
                writer.writeString(12, this.muir_glacier_block);
            if (this.berlin_block.length)
                writer.writeString(13, this.berlin_block);
            if (this.london_block.length)
                writer.writeString(17, this.london_block);
            if (this.arrow_glacier_block.length)
                writer.writeString(18, this.arrow_glacier_block);
            if (this.gray_glacier_block.length)
                writer.writeString(20, this.gray_glacier_block);
            if (this.merge_netsplit_block.length)
                writer.writeString(21, this.merge_netsplit_block);
            if (this.shanghai_block.length)
                writer.writeString(22, this.shanghai_block);
            if (this.cancun_block.length)
                writer.writeString(23, this.cancun_block);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 18:
                        ...
                        break;
                    case 20:
                        message.gray_glacier_block = reader.readString();
                        break;
                    case 21:
                        message.merge_netsplit_block = reader.readString();
                        break;
                    case 22:
                        message.shanghai_block = reader.readString();
                        break;
                    case 23:
                        message.cancun_block = reader.readString();
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class TraceConfig extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("tracer_json_config" in data && data.tracer_json_config != undefined) {
                    this.tracer_json_config = data.tracer_json_config;
                }
            }
        }
        get tracer() {
        ...
        get tracer_json_config() {
            return pb_1.Message.getFieldWithDefault(this, 13, "") as string;
        }
        set tracer_json_config(value: string) {
            pb_1.Message.setField(this, 13, value);
        }
        static fromObject(data: {
            tracer?: string;
            ...
            if (data.tracer_json_config != null) {
                message.tracer_json_config = data.tracer_json_config;
            }
            return message;
        }
        toObject() {
            ...
            if (this.tracer_json_config != null) {
                data.tracer_json_config = this.tracer_json_config;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.enable_memory != false)
                writer.writeBool(11, this.enable_memory);
            if (this.enable_return_data != false)
                writer.writeBool(12, this.enable_return_data);
            if (this.tracer_json_config.length)
                writer.writeString(13, this.tracer_json_config);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        message.tracer_json_config = reader.readString();
                        break;
                    default: reader.skipField();
                }
            }
