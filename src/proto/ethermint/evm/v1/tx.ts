...
export namespace ethermint.evm.v1 {
    export class MsgEthereumTx extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            data?: dependency_5.google.protobuf.Any;
            size?: number;
            hash?: string;
            from?: string;
        }) {
        ...
        set data(value: dependency_5.google.protobuf.Any) {
        ...
        static fromObject(data: {
            data?: ReturnType<typeof dependency_5.google.protobuf.Any.prototype.toObject>;
            size?: number;
            hash?: string;
            from?: string;
        }): MsgEthereumTx {
            ...
            if (data.data != null) {
                message.data = dependency_5.google.protobuf.Any.fromObject(data.data);
            }
            if (data.size != null) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgEthereumTx {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.data, () => message.data = dependency_5.google.protobuf.Any.deserialize(reader));
                        break;
                    case 2:
    ...
    export class AccessListTx extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            value?: string;
            data?: Uint8Array;
            accesses?: dependency_2.ethermint.evm.v1.AccessTuple[];
            v?: Uint8Array;
            r?: Uint8Array;
            s?: Uint8Array;
        }) {
        ...
        get accesses() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.ethermint.evm.v1.AccessTuple, 8) as dependency_2.ethermint.evm.v1.AccessTuple[];
        }
        set accesses(value: dependency_2.ethermint.evm.v1.AccessTuple[]) {
        ...
        static fromObject(data: {
            ...
            value?: string;
            data?: Uint8Array;
            accesses?: ReturnType<typeof dependency_2.ethermint.evm.v1.AccessTuple.prototype.toObject>[];
            v?: Uint8Array;
            r?: Uint8Array;
            s?: Uint8Array;
        }): AccessListTx {
            ...
            if (data.accesses != null) {
                message.accesses = data.accesses.map(item => dependency_2.ethermint.evm.v1.AccessTuple.fromObject(item));
            }
            if (data.v != null) {
                message.v = data.v;
            }
        ...
        toObject() {
            ...
            if (this.accesses != null) {
                data.accesses = this.accesses.map((item: dependency_2.ethermint.evm.v1.AccessTuple) => item.toObject());
            }
            if (this.v != null) {
                data.v = this.v;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.accesses.length)
                writer.writeRepeatedMessage(8, this.accesses, (item: dependency_2.ethermint.evm.v1.AccessTuple) => item.serialize(writer));
            if (this.v.length)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        reader.readMessage(message.accesses, () => pb_1.Message.addToRepeatedWrapperField(message, 8, dependency_2.ethermint.evm.v1.AccessTuple.deserialize(reader), dependency_2.ethermint.evm.v1.AccessTuple));
                        break;
                    case 9:
                        message.v = reader.readBytes();
                        break;
    ...
    export class DynamicFeeTx extends pb_1.Message {
        ...
        get accesses() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.ethermint.evm.v1.AccessTuple, 9) as dependency_2.ethermint.evm.v1.AccessTuple[];
        }
        set accesses(value: dependency_2.ethermint.evm.v1.AccessTuple[]) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.accesses.length)
                writer.writeRepeatedMessage(9, this.accesses, (item: dependency_2.ethermint.evm.v1.AccessTuple) => item.serialize(writer));
            if (this.v.length)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        reader.readMessage(message.accesses, () => pb_1.Message.addToRepeatedWrapperField(message, 9, dependency_2.ethermint.evm.v1.AccessTuple.deserialize(reader), dependency_2.ethermint.evm.v1.AccessTuple));
                        break;
                    case 10:
                        message.v = reader.readBytes();
                        break;
    ...
    export class MsgEthereumTxResponse extends pb_1.Message {
        ...
        get logs() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_2.ethermint.evm.v1.Log, 2) as dependency_2.ethermint.evm.v1.Log[];
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.logs.length)
                writer.writeRepeatedMessage(2, this.logs, (item: dependency_2.ethermint.evm.v1.Log) => item.serialize(writer));
            if (this.ret.length)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.logs, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_2.ethermint.evm.v1.Log.deserialize(reader), dependency_2.ethermint.evm.v1.Log));
                        break;
                    case 3:
